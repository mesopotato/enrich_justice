...
# Step 1: Create the articles_bern_history table in PostgreSQL
create_table_sql = '''
...
mysql_cursor.execute("SELECT * FROM articles_bern_history")
...
# Since there's no primary key or sequence, we don't need to adjust any sequences.
